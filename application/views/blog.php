...
<body>
	...
	<div class="container">
	<header><img src="<?php echo base_url().'image/logo.jpg'?>" width="70" height="70"><h1>My Blog</h1></header>
...
Jumlah jam per minggu untuk tiap-tiap mata kuliah ditentukan atas dasar sasaran kemampuan dan keterampilan yang akan dicapai.
	...
	<footer><img src="<?php echo base_url().'image/logo.jpg'?>" width="30" height="30">	copyright &copy; NoveliaYuliartika.com</footer>
