...
<body>
	...
	<div class="container">
		<div class="col-sm-12 col-md-12">
			<header>
		<img src="<?php echo base_url().'image/logo.jpg'?>" width="70" height="70">
	<marquee>
...
<div style="background-color: #F08080;color: white;padding: 1px" align="center">
	<h3><button type="submit" class="btn btn-default"><a href="home">Home</a></button><br><br>
  	...
  	<button type="submit" class="btn btn-default"><a href="blog">My Blog</a></button></h3>
</div>
</form>

	<footer><img src="<?php echo base_url().'image/logo.jpg'?>" width="30" height="30">
